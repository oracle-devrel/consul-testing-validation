...
resource "oci_core_network_security_group_security_rule" "consul_to_tcp_443" {
  provider = oci.rgn1
  network_security_group_id = oci_core_network_security_group.consul_rgn1.id
  direction = "EGRESS"
  protocol = "6"
  ...
  description = "Permit tcp/443 traffic"
...
# resource "oci_core_network_security_group_security_rule" "i_from_bastion_ssh" {
#   provider = oci.rgn1
#   network_security_group_id = oci_core_network_security_group.consul_rgn1.id
#   direction = "INGRESS"
#   protocol = "6"
...
#   source = "${oci_bastion_bastion.rgn1.private_endpoint_ip_address}/32"
